 ...
 */
final class Version20190609203311 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE system_user ADD roles JSON NOT NULL, CHANGE id id INT AUTO_INCREMENT NOT NULL, CHANGE username username VARCHAR(180) NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE system_user DROP roles, CHANGE id id BIGINT UNSIGNED AUTO_INCREMENT NOT NULL, CHANGE username username VARCHAR(255) NOT NULL COLLATE utf8mb4_unicode_ci');
